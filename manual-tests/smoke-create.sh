...
copperhead create --brief brief.md --model "$MODEL" --plain 2>&1 | tee run.log
...
# Check for KiCad artifacts generated by bootstrap
KICAD_SCH=$(ls *.kicad_sch 2>/dev/null | head -1)
...
KICAD_PCB=$(ls *.kicad_pcb 2>/dev/null | head -1)
